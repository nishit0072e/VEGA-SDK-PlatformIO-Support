...
void main() {
  ...
  i2c_configure(I2C_0, SYSTEM_FREQUENCY, 100000); // 100MHz sys, 100kHz I2C
  ssd1306_begin(SSD1306_SWITCHCAPVCC, SSD1306_I2C_ADDRESS);

  extern char buffer_logo[];
  printf("\n\r Logo data check: %02x %02x %02x %02x\n\r", buffer_logo[0],
         buffer_logo[1], buffer_logo[2], buffer_logo[3]);
  ...
  while (1) {
    ssd1306_clearDisplay();
    char *text =
        "VEGA series of microprocessors are developed as part of the "
        "Microprocessor Development Programme initiated and funded by MeitY";
